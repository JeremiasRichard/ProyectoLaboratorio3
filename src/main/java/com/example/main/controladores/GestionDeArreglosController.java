...
public class GestionDeArreglosController {
    ...
    private Cliente seleccionado = new Cliente();
    ...
    private void modificarArreglo(ArregloDTO arregloDTO, Arreglo arreglo) throws EntidadDuplicadaException {
    ...
    private void eliminarArreglo(ActionEvent event) throws EntidadNoEncontradaException {
        ArregloDTO arregloDTO = this.tblArreglos.getSelectionModel().getSelectedItem();
        ...
        if (arregloDTO == null) {
            ...
            arregloService.eliminadoLogico(arregloDTO.getIdArreglo());
            actualizarLista();
        }
    }
    ...
    private void incicializarTablaArreglos() {
